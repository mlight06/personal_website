...
import {
  Container, Grid, Card, CardContent, Typography, createTheme, ThemeProvider,
} from '@mui/material';
...
export default function NewPortfolio() {
  ...
  return (
    ...
    >
      ...
      <div>
        <ThemeProvider theme={headlines}>
          <a href="https://docs.google.com/document/d/1QBoyu2hqYuyh1bPEof7Mj2ymZOlPK8tKtI6nK1qZinU/edit?usp=sharing" target="_blank" rel="noreferrer">
